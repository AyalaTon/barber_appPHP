    ...
    <div class="column-responsive">
        <div class="horarioBarbero form content" style="background-color: <?php echo $background2; ?>!important;">
            ...
            <fieldset style="color: <?php echo $color; ?> !important; ">
                ...
                <input style="color: <?php echo $color; ?> !important; " required type="date" label="Fecha desde" name="fecha_desde" id="fecha_desde" />
                <label hidden id="label_fecha_hasta">Fecha hasta</label>
                <input style="color: <?php echo $color; ?> !important; " hidden type="date" label="Fecha hasta" name="fecha_hasta" id="fecha_hasta" />
                <?php

        ...
        map.on('click', function(evt) {
            ...
            if (feature) {
                ...
                $(element).popover({
                    ...
                    'content': '<div"><img src="https://www.pngkey.com/png/detail/409-4092711_proximamente-png-proximamente.png" alt="Barberia" style="width:100%"><div class="container"><h4><b>' + feature.get('name') + '</b></h4> <p>' + feature.get('address') + '</p> </div></div>'
                });
